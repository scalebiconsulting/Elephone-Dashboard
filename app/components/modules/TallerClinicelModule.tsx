...
const ESTADO_FILTRO = 'TALLER CLINICEL';

export default function TallerClinicelModule() {
  ...
  const fetchProductos = useCallback(async () => {
    ...
    try {
      ...
      if (data.success) {
        // Filtrar solo productos en TALLER CLINICEL
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-3xl font-bold text-white">Taller Clinicel</h1>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-[#1e293b] border border-[#334155] rounded-xl p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-slate-400 text-sm">Productos en Taller</p>
        ...
        <div className="bg-[#1e293b] border border-[#334155] rounded-xl p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-slate-400 text-sm">Valor en Taller</p>
      ...
      <div className="bg-[#1e293b] border border-[#334155] rounded-xl p-6">
        <div className="relative max-w-md">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 bg-[#0f172a] border border-[#334155] rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-orange-500"
          />
        </div>
      </div>
      ...
      <div className="bg-[#1e293b] border border-[#334155] rounded-xl overflow-hidden">
        {loading ? (
          ...
          <div className="p-8 text-center text-slate-400">No hay productos en taller</div>
        ) : (
