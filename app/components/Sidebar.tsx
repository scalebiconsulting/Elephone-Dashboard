...
import { LayoutDashboard, ShoppingCart, ShoppingBag, Package, RefreshCw, CalendarClock, Wrench, Warehouse, Truck, CreditCard } from 'lucide-react';
...
export default function Sidebar({ activeModule, onChangeModule }: SidebarProps) {
  const menuItems = [
    ...
    { id: 'cuentas', label: 'Cuentas por Pagar', icon: CreditCard },
    { id: 'taller', label: 'Taller Clinicel', icon: Wrench },
    { id: 'bodega', label: 'Stock Bodega', icon: Warehouse },
    { id: 'transito', label: 'Tránsito a Taller', icon: Truck },
  ];
